    ...
    return res.status(200).json({
      ...
      implementation: {
        ...
        steps: [
          ...
          { step: 'Colaboradores marcan por RUT o PIN', time: 'Mismo día' },
        ],
      },
      contract: {
        minMonths: 6,
        cancellation: '30 días de aviso',
        digital: true,
        link: `/contrato/${slug}`,
      },
    });
...
function formatDbProposal(p) {
  ...
  return {
    ...
    contract: {
      minMonths: p.min_contract_months || 6,
      cancellation: `${p.cancellation_days || 30} días de aviso`,
      digital: true,
      link: null,
    },
    notes: p.notes,
